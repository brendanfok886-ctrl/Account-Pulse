...
**[View Demo Report](./AccountPulse_Demo_Report.pdf)** · **[Standalone HTML Source](./AccountPulse_Demo_Report.html)** · **[Run the Workflow](#quick-start)**
...
## See the report before running the workflow

<a href="./AccountPulse_Demo_Report.pdf">
  <img src="./accountpulse-demo-preview.png" alt="AccountPulse demo report preview" width="100%">
</a>

**[Open the complete PDF report](./AccountPulse_Demo_Report.pdf)** · **[View the standalone HTML source](./AccountPulse_Demo_Report.html)**

> The demo uses purpose-built synthetic data engineered to demonstrate all four alert states and an insufficient-data case. It contains no client or company information.
...
- **[Complete demo report](./AccountPulse_Demo_Report.pdf)** — recruiter-friendly sample output using synthetic data
- **[Standalone demo HTML](./AccountPulse_Demo_Report.html)** — responsive report that can also be hosted with GitHub Pages
